"""FastAPI application for ai-content-watermark."""
...
app = FastAPI(title="ai-content-watermark", version="0.1.0", description="ai-content-watermark API")
...
@app.get("/health")
def health():
    return {"status": "ok", "service": "ai-content-watermark", "version": "0.1.0"}
...
async def process(req: ProcessRequest):
    ...
    try:
        ...
        resp = ProcessResponse(success=True, result=result, processing_time_ms=round(elapsed, 2),
                              metadata={"service": "ai-content-watermark", "input_length": len(req.input)})
...
@app.get("/status")
def status():
    return {"service": "ai-content-watermark", "version": "0.1.0", "ready": True,
